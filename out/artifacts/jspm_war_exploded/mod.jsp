...
<div class="container" style="max-width:450px"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="login?ac=adminuppass" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder="请输入原密码" name="ymm"/>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder="请输入新密码" name="xmm1"/>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" autocomplete="off" placeholder="请输入确认密码" name="xmm2"/>
