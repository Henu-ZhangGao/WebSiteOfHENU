...
List<HashMap> list = Query.make("yonghu").where(where).order(orderby+" "+sort).page(15);
...
<div class="panel panel-default">
    ...
    性别
                            ...
                            <select class="form-control class_xingbie1" data-value="<%= request.getParameter("xingbie") !=null ? request.getParameter("xingbie") : "" %>" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie">
