...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
             ...
             if(request.getParameter("username") != null && !"".equals( request.getParameter("username") )){ where+=" AND username LIKE '%"+request.getParameter("username")+"%'"; } 
                
List<HashMap> list = Query.make("admins").where(where).order(orderby+" "+sort).page(15);
