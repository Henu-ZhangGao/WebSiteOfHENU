...
List<HashMap> list = Query.make("pinglunhuifu").where(where).order(orderby+" "+sort).page(15);
...
<td> <%= Info.subStr(map.get("addtime") , 19 , "") %> </td>
                                                                ...
                                                                <a href="pinglunhuifu_updt.jsp?id=<%= map.get("id") %>">编辑</a>
                                                                <a href="pinglunhuifu.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
