...
List<HashMap> list = Query.make("lunbotu").where(where).order(orderby+" "+sort).page(15);
...
<div class="panel panel-default">
    ...
    标题
                            ...
                            <input type="text" class="form-control" style="" name="title" value="<%= request.getParameter("title") !=null ? request.getParameter("title") : "" %>"/>                        
</div>
...
<td> <%= Info.subStr(map.get("addtime") , 19 , "") %> </td>
                                                                ...
                                                                <a href="lunbotu_updt.jsp?id=<%= map.get("id") %>">编辑</a>
                                                                <a href="lunbotu.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                                        <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
