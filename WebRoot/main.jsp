...
<header class="header">
    <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
        ...
        <a href="index.jsp" class="font-weight-bold text-uppercase text-base">新闻网站</a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
            <li class="nav-item ml-auto">
                <a href="./" target="_blank" class="btn btn-primary">前台首页</a>
            </li>
            <li class="nav-item ml-2">
                <a href="logout.jsp" class="btn btn-danger" onclick="return confirm('你确定退出？')">安全退出</a>
            </li>
            <li class="nav-item ml-2">
                欢迎登录：<%= request.getSession().getAttribute("username") !=null ? request.getSession().getAttribute("username") : "" %>，<%= request.getSession().getAttribute("cx") !=null ? request.getSession().getAttribute("cx") : "" %>
            </li>
...
<div class="d-flex align-items-stretch">
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
            <section class="py-5">
                <div class="iframe">
                    <iframe src="sy.jsp" name="main" frameborder="0" marginwidth="0" marginheight="0" scrolling="auto"></iframe>
                </div>
